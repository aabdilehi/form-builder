        ...
        <div className="flex w-full flex-col items-center gap-6">
          ...
          <div className="flex w-full flex-col items-center justify-center gap-2">
            ...
            >
              ...
              <button
                type="submit"
                className="active:scale-95 transition transition-all duration-150 flex h-10 items-center justify-center rounded-md bg-indigo-500 hover:bg-indigo-400 sm:text-lg"
              >
            ...
            >
              <button
                type="submit"
                className="active:scale-95 transition transition-all duration-150 flex h-10 items-center justify-center rounded-md bg-gray-200"
              >
